...
export const users = pgTable('users', {
  ...
  loyaltyDiscountUnlockedAt: text('loyalty_discount_unlocked_at'),
  createdAt: text('created_at').notNull(),
  updatedAt: text('updated_at').notNull(),
}, (table) => [
...
export const bookings = pgTable('bookings', {
  ...
  loyaltyDiscountPercent: integer('loyalty_discount_percent').notNull().default(0),
  loyaltyDiscountPence: integer('loyalty_discount_pence').notNull().default(0),
  ...
  reminderEmailStatus: text('reminder_email_status', { enum: ['pending', 'sending', 'sent'] }).notNull().default('pending'),
  reminderEmailSentAt: text('reminder_email_sent_at'),
  reminderEmailMessageId: text('reminder_email_message_id'),
  reminderEmailClaimedAt: text('reminder_email_claimed_at'),
  createdAt: text('created_at').notNull(),
  updatedAt: text('updated_at').notNull(),
}, (table) => [
  ...
  index('idx_bookings_reminder_status').on(table.status, table.reminderEmailStatus),
